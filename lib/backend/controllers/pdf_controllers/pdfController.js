...
export const uploadPdf = async(req, res) => {
    try {
        ...
        upload.single("file")(req, res, async(err) => {
            ...
            form.append("email", userEmail); // send email field
            form.append("file", fs.createReadStream(fileInfo.path)); // send actual file as binary

            await axios.post("https://dhruv-chotai-10.app.n8n.cloud/webhook-test/send-financial-report", form, {
