...
export const uploadPdf = async(req, res) => {
    ...
    try {
        ...
        upload.single("file")(req, res, async(err) => {
            ...
            if (req.body.userId) {
                try {
                    ...
                    try {
                        ...
                        form.append("email", userEmail || "user@example.com");
                        ...
                        // Add the PDF file as a readable stream with explicit content type
                        ...
                        console.log("Form data created with fields:", form.getHeaders());
            ...
            // Return success response with email and file info
            res.status(200).json({
                success: true,
